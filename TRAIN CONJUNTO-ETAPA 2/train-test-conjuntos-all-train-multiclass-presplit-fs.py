...
columns_to_select = ['duration', 'orig_bytes', 'history', 'orig_pkts', 'orig_ip_bytes',
                     'orig_bytes_mean', 'orig_bytes_mean_nocero', 'orig_bytes_max',
                     'orig_pkts_cero', 'time_mean', 'time_std', 'time_max', 'orig_time_mean',
                     'orig_time_std', 'orig_time_max', 'label','binary-label']

sampled_iot23_df = sampled_iot23_df[columns_to_select]
iotd20_df = iotd20_df[columns_to_select]
sampled_cic_df = sampled_cic_df[columns_to_select]
...
Top 15 features selected based on information gain:
Index(['duration', 'orig_bytes', 'history', 'orig_pkts', 'orig_ip_bytes',
       'orig_bytes_mean', 'orig_bytes_mean_nocero', 'orig_bytes_max',
       'orig_pkts_cero', 'time_mean', 'time_std', 'time_max', 'orig_time_mean',
       'orig_time_std', 'orig_time_max'],
      dtype='object')
...
def train_and_evaluate_model(name, model, X_train, X_test, y_train, y_test):
    ...
    try:
        ...
        # Save PDF
        pdf_output_path = f"/root/resultados-ml/conjunto/conjunto-{name}-60test-mix-train-multiclass-fs-presplit-classification_report.pdf"
